...
export default function FloatingCartButton() {
  ...
  return (
    <button
      onClick={toggleCart}
      className="fixed bottom-6 right-3.5 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white w-16 h-16 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 z-30 flex items-center justify-center group"
