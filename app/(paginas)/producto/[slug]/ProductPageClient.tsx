...
// ✅ Ahora recibe el producto ya cargado desde el servidor (page.tsx)
export default function ProductPageClient({ product }: { product: Product }) {
  const [selectedImage, setSelectedImage] = useState(product.imagenUrl || "");
  ...
  // Los productos relacionados sí se cargan en el cliente —
  // esto no afecta al link compartido, solo es contenido adicional
  useEffect(() => {
    ...
    loadRelatedProducts();
  }, [product._id, product.categoriaSlug, product.categoria]);
