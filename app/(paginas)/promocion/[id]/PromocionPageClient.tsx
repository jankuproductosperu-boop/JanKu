...
// ✅ Ahora recibe la promoción ya cargada desde el servidor (page.tsx),
// y el índice ya calculado (para el "Promoción N" que se usa en el carrito)
export default function PromocionPageClient({
  promotion,
  promotionIndex,
}: {
  promotion: Promotion;
  ...
  const [selectedImage, setSelectedImage] = useState(promotion.imagenUrl || "");
